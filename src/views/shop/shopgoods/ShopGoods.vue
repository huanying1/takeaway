  ...
  <div>
    <div class="goods">
      ...
      <div class="foods-wrapper">
        <ul>
          <li class="food-list-hook" ref="fList" v-for="(good, index) in goods" :key="index">
...
<script>
  ...
  export default {
    ...
    watch: {
      // goods() {
      //   this.$nextTick(() => {
      //     let leftBScroll = new BScroll('.menu-wrapper')
      //     let rightBScroll = new BScroll('.foods-wrapper')
      //   })
      // }
    }
  }
